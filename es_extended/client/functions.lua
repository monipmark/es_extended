...
function ESX.Game.Utils.DrawTextHelp(coords, text)
	AddTextEntry('HelpNotification', "<font face='font4thai'>"..text.."</font>")
									...
									if type == 'item_weapon' then
										...
										ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'inventory_item_count_give', {
											...
											if quantity and quantity > 0 and data.current.count >= quantity then
												...
												exports['cc_text_UI']:ShowHelpNotification(_U('amount_invalid'))
											end

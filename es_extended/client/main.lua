...
RegisterNetEvent('esx:updateWeaponpercent')
AddEventHandler('esx:updateWeaponpercent', function(param)
	for k,v in ipairs(ESX.PlayerData.loadout) do
		if v.name == param.name then
			v.percent = param.percent
		end
	end
end)
...
RegisterNetEvent('esx:addInventoryItem') -- ESX.PlayerData.weight = newWeight
AddEventHandler('esx:addInventoryItem', function(item, count, weight)
...
AddEventHandler('esx:removeInventoryItem', function(item, count, weight)
	ESX.PlayerData.weight = weight
	for k,v in ipairs(ESX.PlayerData.inventory) do
		if v.name == item then
...
AddEventHandler('esx:addWeapon', function(weapon, ammo, loadout)
...
AddEventHandler('esx:removeWeapon', function(weapon, loadout)
